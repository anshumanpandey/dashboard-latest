    ...
    Datetimepicker.prototype = {
        ...
        showMode: function (dir) {
			...
			*/
            ...
            //if (DPGlobal.modes[this.viewMode].clsName == 'days' || DPGlobal.modes[this.viewMode].clsName == 'months' || DPGlobal.modes[this.viewMode].clsName == 'years') {
                this.picker.find('>div').hide().filter('.datetimepicker-' + DPGlobal.modes[this.viewMode].clsName).css('display', 'block');
                //this.picker.find('>div').filter(".datetimepicker-minutes").css('display', 'block');
                //this.picker.find('>div').filter(".datetimepicker-hours").css('display', 'block');
            //}
            this.updateNavArrows();
        },
